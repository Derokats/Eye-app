    	...
    	<div class="container">
        	<div class="subbanner-content banner-content">
            	<div class="skew-effect fadeInLeft animated">
                   	<span class="fw-normal">Kids</span>
				</div>
	...
	<div class="container">
		...
		<div class="clearfix marbot10 animatedParent animateOnce" data-sequence='250'>
            <div class="row">
                ...
                <div class="col-md-4 marbot30 fadeInRight animated" data-id='1'>
                    <div class="text-center">
                        <div class="grid image-effect2">
                            <a href="#">
                                <figure>
                                    <img src="assets/images/products/k1.jpg" alt=" " class="img-responsive">
                        ...
                        <div class="panel panel-body marbot0 clearfix doctor-details">
                            <h3 class="marbot0">Ray Ban RB 1535</h3>
                           <!-- <p class="fontresize marbot10 color-light"><em> <span class="fw-500">Doctor of Ophthalmologist</span> </em></p>-->
                          
                        </div>
                    </div>
                </div>
                
                <div class="col-md-4 marbot30 fadeInRight animated" data-id='2'>
                    <div class="text-center">
                        <div class="grid image-effect2">
                            <a href="#">
                                <figure>
                                    <img src="assets/images/products/k2.jpg" alt=" " class="img-responsive">
                                    <figcaption><i class="fa flaticon-link-1 gallery-icon transition"></i></figcaption>
                                </figure>
                            </a>
                        </div>
                        <div class="panel panel-body marbot0 clearfix doctor-details">
                            <h3 class="marbot0">Ray Ban RB 1550</h3>
                ...
                <div class="col-md-4 marbot30 fadeInRight animated" data-id='3'>
                    <div class="text-center">
                        <div class="grid image-effect2">
                            <a href="#">
                                <figure>
                                    <img src="assets/images/products/k3.jpg" alt=" " class="img-responsive">
                                    <figcaption><i class="fa flaticon-link-1 gallery-icon transition"></i></figcaption>
                                </figure>
                            </a>
                        </div>
                        <div class="panel panel-body marbot0 clearfix doctor-details">
                            <h3 class="marbot0">Ray Ban RJ 90506S</h3>
            ...
            <div class="col-md-4 marbot30 fadeInRight animated" data-id='4'>
        		
                <div class="text-center">
                	<div class="grid image-effect2">
                    	<a href="#">
                            <figure>
                                <img src="assets/images/products/k4.jpg" alt=" " class="img-responsive">
                                <figcaption><i class="fa flaticon-link-1 gallery-icon transition"></i></figcaption>
                            </figure>
                        </a>
                    </div>
                    ...
                    <div class="panel panel-body marbot0 clearfix doctor-details">
                        <h3 class="marbot0">Ray Ban RJ 9056S</h3>
            ...
            <div class="col-md-4 marbot30 fadeInRight animated" data-id='5'>
        		
                <div class="text-center">
                	<div class="grid image-effect2">
                    	<a href="#">
                            <figure>
                                <img src="assets/images/products/k5.jpg" alt=" " class="img-responsive">
                                <figcaption><i class="fa flaticon-link-1 gallery-icon transition"></i></figcaption>
                            </figure>
                        </a>
                    </div>
                    ...
                    <div class="panel panel-body marbot0 clearfix doctor-details">
                        <h3 class="marbot0">Ray Ban RJ 9063S</h3>
