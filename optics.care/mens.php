                ...
                <div class="col-md-4 marbot30 fadeInRight animated" data-id='1'>
                    <div class="text-center">
                        <div class="grid image-effect2">
                            <a href="#">
                                <figure>
                                    <img src="assets/images/products/m1.jpg" alt=" " class="img-responsive">
                ...
                <div class="col-md-4 marbot30 fadeInRight animated" data-id='2'>
                    <div class="text-center">
                        <div class="grid image-effect2">
                            <a href="#">
                                <figure>
                                    <img src="assets/images/products/m2.jpg" alt=" " class="img-responsive">
                                    <figcaption><i class="fa flaticon-link-1 gallery-icon transition"></i></figcaption>
                                </figure>
                            </a>
                        </div>
                        <div class="panel panel-body marbot0 clearfix doctor-details">
                            <h3 class="marbot0">Blackfin BF 604</h3>
                ...
                <div class="col-md-4 marbot30 fadeInRight animated" data-id='3'>
                    <div class="text-center">
                        <div class="grid image-effect2">
                            <a href="#">
                                <figure>
                                    <img src="assets/images/products/m3.jpg" alt=" " class="img-responsive">
                                    <figcaption><i class="fa flaticon-link-1 gallery-icon transition"></i></figcaption>
                                </figure>
                            </a>
                        </div>
                        <div class="panel panel-body marbot0 clearfix doctor-details">
                            <h3 class="marbot0">Blackfin BF 667</h3>
            ...
            <div class="col-md-4 marbot30 fadeInRight animated" data-id='4'>
                ...
                <div class="text-center">
                	<div class="grid image-effect2">
                    	<a href="#">
                            <figure>
                                <img src="assets/images/products/m4.jpg" alt=" " class="img-responsive">
                                <figcaption><i class="fa flaticon-link-1 gallery-icon transition"></i></figcaption>
                            </figure>
                        </a>
                    </div>
                    ...
                    <div class="panel panel-body marbot0 clearfix doctor-details">
                        <h3 class="marbot0">Burberry B 1289</h3>
