    	...
    	<div class="container">
        	<div class="subbanner-content banner-content">
            	<div class="skew-effect fadeInLeft animated">
                   	<span class="fw-normal">Accessories</span>
				</div>
                ...
                <div class="col-md-4 marbot30 fadeInRight animated" data-id='1'>
                    <div class="text-center">
                        <div class="grid image-effect2">
                            <a href="#">
                                <figure>
                                    <img src="assets/images/products/a1.jpg" alt=" " class="img-responsive">
                        ...
                        <div class="panel panel-body marbot0 clearfix doctor-details">
                            <h3 class="marbot0">Anti-Fog Solution</h3>
                ...
                <div class="col-md-4 marbot30 fadeInRight animated" data-id='2'>
                    <div class="text-center">
                        <div class="grid image-effect2">
                            <a href="#">
                                <figure>
                                    <img src="assets/images/products/a2.jpg" alt=" " class="img-responsive">
                                    <figcaption><i class="fa flaticon-link-1 gallery-icon transition"></i></figcaption>
                                </figure>
                            </a>
                        </div>
                        <div class="panel panel-body marbot0 clearfix doctor-details">
                            <h3 class="marbot0">Cleaning Kit</h3>
                ...
                <div class="col-md-4 marbot30 fadeInRight animated" data-id='3'>
                    <div class="text-center">
                        <div class="grid image-effect2">
                            <a href="#">
                                <figure>
                                    <img src="assets/images/products/a3.jpg" alt=" " class="img-responsive">
                                    <figcaption><i class="fa flaticon-link-1 gallery-icon transition"></i></figcaption>
                                </figure>
                            </a>
                        </div>
                        <div class="panel panel-body marbot0 clearfix doctor-details">
                            <h3 class="marbot0">LALOOP 001</h3>
            ...
            <div class="col-md-4 marbot30 fadeInRight animated" data-id='5'>
                ...
                <div class="text-center">
                	<div class="grid image-effect2">
                    	<a href="#">
                            <figure>
                                <img src="assets/images/products/a4.jpg" alt=" " class="img-responsive">
                                <figcaption><i class="fa flaticon-link-1 gallery-icon transition"></i></figcaption>
                            </figure>
                        </a>
                    </div>
                    ...
                    <div class="panel panel-body marbot0 clearfix doctor-details">
                        <h3 class="marbot0">Cleaning Cloth X-Large</h3>
